...
//  const fetch
  ...
  return (
    <div className="all-home min-h-screen bg-gray-900 text-white flex py-5 lg:py-10 ">
      ...
      <Sidebar BASE_URL={BASE_URL} API_KEY={API_KEY} IMAGE_BASE_URL={IMAGE_BASE_URL} setResults = {setResults}/>
        ...
        </div>
        {
          ...
          <div className= "flex-1 flex flex-col max-w-[1600px] self-center gap-8 w-full">
            ...
            <section className="flex flex-col relative gap-8 lg:pl-10 mb-20 lg:mb-0">
              <Movies IMAGE_BASE_URL={IMAGE_BASE_URL} item={popularMovies} menuItem={menuItem} title='Filmes populares' />
              <Movies IMAGE_BASE_URL={IMAGE_BASE_URL} item={horrorMovies} menuItem={menuItem} title='Filmes de terror' />
              <Movies IMAGE_BASE_URL={IMAGE_BASE_URL} item={ficcaoCientifica} menuItem={menuItem} title='Filmes de ficção científica' />
            </section>
          </div>
          :
          <div className="flex-1 flex flex-col max-w-[1600px] self-center gap-8 w-full lg:px-10 ">
            <SearchResults results={results} IMAGE_BASE_URL={IMAGE_BASE_URL} menuItem={menuItem}/>
          </div>
        }
